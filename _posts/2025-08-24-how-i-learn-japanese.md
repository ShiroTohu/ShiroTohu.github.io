...
I'm very glad that I did because it serves as a good hobby to relax with after a day of programming or studying. I feel like I am using my time wisely even though I'm watching anime or playing video games... after I have done my kanji and grammar practice for the day.
...
| [reader ttsu](https://reader.ttsu.app/b?id=1)                                                                         | Great ebook reader that supports yomitan. (although it does not support local storage for self hosting)                                                                                         |
| [Lapis modified](https://github.com/friedrich-de/lapis-modified)                                                      | Mining deck for anki                                                                                                                                                                            |
| [TheMoeWay Discord](https://learnjapanese.moe/)                                                                       | They have ranks in their discord which you can achieve by taking tests using their bot. It is very fun and a good motivator for learning the kaishi deck.                                       |

## Good shows
The best shows are the ones that you are compelled to understand, this is usually the advice that I hear. I also try to watch shows that I have already watched. This gives me more context and allows me to have more comprehensible input. Here are some of the shows that I have watched.
...
| [Gachiakuta](https://en.wikipedia.org/wiki/Gachiakuta)                             | One of the harder ones I think I have watched                                                                                                                                                                                                                                                                      |
| [Dandadan](https://en.wikipedia.org/wiki/Dandadan)                                 | Felt like I could follow along with the story quite well                                                                                                                                                                                                                                                           |

## Mining
Mining is creating flashcards from the real content that you consume. I make this process a lot easier by using [Yomitan](https://yomitan.wiki/) which creates these cards for me. The template that I use is the [lapis modified](https://github.com/friedrich-de/lapis-modified) deck which has suited my needs quite well.

[animecards](https://animecards.site/yomichansetup/#connect-yomitan-and-anki) Has a good guide on how to configure Lapis and Yomitan.

When it comes to remembering words I learn through mining I only try to remember the pronunciation of the words not their meaning. This is because for those N3 or above you should be focusing a lot on immersion rather than trying to remember the words you encounter.

## Playing Video Games
To my understanding if you want to play video games you can do so in either two ways:
- Changing the language of the game to Japanese
- Listen to a Japanese podcast in the background
From what I have experienced these are good ways to passively listen and get some reps in without interacting with the language to a high degree. Changing a game's language to Japanese allows for experiencing the language outside of dedicated study hours it also can be very useful in learning katakana depending on the game that you play.

Japanese podcasts in the background is also a good passive way to learn Japanese in the background. You just have to make sure that the task you are doing doesn't require intense focus. For example sometimes I log into Hypixel and do some parkour while listening. Here are some games that I recommend
- Minecraft
- Euro Truck Simulator 2
- Warframe (really depends on what you are doing)
...
There are also some user contributed sync server dockerfiles on their [GitHub](https://github.com/ankitects/anki/tree/main/docs/syncserver).
